...
import { MAX_LIMIT, MIN_LIMIT, MIN_SQRT_PRICE, OFFSET } from "../../constants"
...
const testLimitToSqrtPriceWidthGt1 = () => {
  const cases = [
    { limit: Number(offset(20)) - 8388600, width: 20 },
    ...
    { limit: Number(offset(25)) + 8388600, width: 25 },
  ]
...
const testSqrtPriceToLimitWidth1 = () => {
  ...
  const cases = [
    ...
    "2353381948048259929879526007797717762022738993",
    "16426135679834711867148424422577661217622160914",
    "16426217810307785371336889841694852951183636405",
  ]
...
const testPriceToLimit = () => {
  ...
  const cases = [
    ...
    { price: "6131213697322783095070105526743751716087489154079457884512865583", width: 1 },
  ]
