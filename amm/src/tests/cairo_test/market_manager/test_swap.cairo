    ...
    markets
        .append(
            MarketStateCase {
                ...
                exp: array![
                    (1000000000000000000, 32834863955144570450305514694953651757643792660, 2500000000000000),
                    (1000000000000000000, 0, 2500000000000000),
                    (1, 1000000000000000000, 0),
                    (0, 0, 0), // 4 - skipped (runs out of liquidity, which is valid but model doesnt handle)
                    (1000000000000000000, 32834863955144570450305514694953651757643792660, 2500000000000000),
                    (0, 0, 0), // 6 - skipped
                    (1, 1000000000000000000, 0),
                    (0, 0, 0), // 8 - skipped
                    ...
                    (100000, 0, 250),
                    (1, 100000, 0),
                    (270209816393105201946059590446309745021559, 100000, 675524540982763004865148976115774362553),
                    (0, 0, 0), // 13 - skipped
                    (
        ...
        .append(
            MarketStateCase {
                ...
                exp: array![
                    ...
                    (1000000000000000000, 32834863955144570450305514694953651757643792660, 2500000000000000),
                    (0, 0, 0), // 3 - skipped (runs out of liquidity, which is valid but model doesnt handle)
                    (1, 999999999999999999, 0),
                    (0, 0, 0), // 5 - skipped (runs out of liquidity, which is valid but model doesnt handle)
                    (1000000000000000000, 32834863955144570450305514694953651757643792660, 2500000000000000),
                    (0, 0, 0), // 7 - skipped (runs out of liquidity, which is valid but model doesnt handle)
                    (1, 999999999999999999, 0),
                    (100001, 0, 251),
                    (100001, 268856047677783457439868432029073499404805, 250),
                    (270209816393105201946059590446309745021559, 100000, 675524540982763004865148976115774362554),
                    (1, 100000, 0),
                    (
