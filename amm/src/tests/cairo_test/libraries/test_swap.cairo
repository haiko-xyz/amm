...
use amm::libraries::swap::{
    compute_swap_amounts, next_sqrt_price_amount_in, next_sqrt_price_amount_out
};
...
fn test_compute_swap_amounts_buy_exact_input_reaches_price_target() {
    ...
    let next_sqrt_price_full_amount = next_sqrt_price_amount_in(
...
fn test_compute_swap_amounts_buy_exact_output_reaches_price_target() {
    ...
    let next_sqrt_price_full_amount = next_sqrt_price_amount_out(
        curr_sqrt_price, liquidity, amount_rem, true
    );
...
/////////////////////////////////////
// TESTS - next_sqrt_price_amount_in
/////////////////////////////////////

#[test]
#[available_gas(2000000000)]
fn test_next_sqrt_price_in_cases() {
    assert(next_sqrt_price_amount_in(1, 1, MAX, false) == 1, 'next_sqrt_price_in_amt_max');
    assert(next_sqrt_price_amount_in(256, 100, 0, false) == 256, 'next_sqrt_price_in_buy_amt_0');
    assert(next_sqrt_price_amount_in(256, 100, 0, true) == 256, 'next_sqrt_price_in_sell_amt_0');
    assert(
        next_sqrt_price_amount_in(MAX, MAX, MAX, false) == ONE, 'next_sqrt_price_in_sell_all_max'
    );
    assert(
        next_sqrt_price_amount_in(ONE, ONE, ONE / 10, true) == 11000000000000000000000000000,
        'next_sqrt_price_in_buy_amt_0.1'
    );
    assert(
        next_sqrt_price_amount_in(ONE, ONE, ONE / 10, false) == 9090909090909090909090909091,
        'next_sqrt_price_in_sell_amt_0.1'
    );
    assert(
        next_sqrt_price_amount_in(ONE, 1, MAX / 2, false) == 1, 'next_sqrt_price_in_sell_rtns_1'
    );
}
...
fn test_next_sqrt_price_in_price_0() {
    next_sqrt_price_amount_in(0, 100, 1, true);
}
...
fn test_next_sqrt_price_in_liq_0() {
    next_sqrt_price_amount_in(100, 0, 1, true);
}
...
fn test_next_sqrt_price_in_price_overflow() {
    next_sqrt_price_amount_in(MAX, 1, 1, true);
}

/////////////////////////////////////
// TESTS - next_sqrt_price_amount_out
/////////////////////////////////////
...
fn test_next_sqrt_price_out_cases() {
    assert(
        next_sqrt_price_amount_out(to_e28(256), 1024, 262143, false) == 9765625000000000000000000,
        'next_sqrt_price_in_amt_max_1'
    );
    assert(next_sqrt_price_amount_out(256, 100, 0, false) == 256, 'next_sqrt_price_out_buy_amt_0');
    assert(next_sqrt_price_amount_out(256, 100, 0, true) == 256, 'next_sqrt_price_out_sell_amt_0');
    assert(
        next_sqrt_price_amount_out(ONE, ONE, ONE / 10, true) == 11111111111111111111111111112,
        'next_sqrt_price_out_buy_0.1'
    );
    assert(
        next_sqrt_price_amount_out(ONE, ONE, ONE / 10, false) == 9000000000000000000000000000,
...
fn test_next_sqrt_price_out_price_0() {
    next_sqrt_price_amount_out(0, 100, 1, true);
}
...
fn test_next_sqrt_price_out_liq_0() {
    next_sqrt_price_amount_out(100, 0, 1, true);
}
...
fn test_next_sqrt_price_out_buy_price_overflow() {
    next_sqrt_price_amount_out(ONE, 1, MAX, true);
}
...
fn test_next_sqrt_price_out_sell_price_overflow() {
    next_sqrt_price_amount_out(ONE, 1, MAX, false);
}
...
fn test_next_sqrt_price_out_output_eq_quote_reserves() {
    next_sqrt_price_amount_out(256, 1024, 262144, false);
}
...
fn test_next_sqrt_price_out_output_gt_quote_reserves() {
    next_sqrt_price_amount_out(256, 1024, 262145, false);
}
...
fn test_next_sqrt_price_out_output_eq_base_reserves() {
    next_sqrt_price_amount_out(256, 1024, 4, false);
}
...
fn test_next_sqrt_price_out_output_gt_base_reserves() {
    next_sqrt_price_amount_out(256, 1024, 5, false);
}
